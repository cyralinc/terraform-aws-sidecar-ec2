...
| <a name="input_healthcheck_port"></a> [healthcheck\_port](#input\_healthcheck\_port) | (Deprecated) Port which will respond with health status on the sidecar.<br><br>This value is deprecated for sidecars v4.7.0 and above, being hardcoded to port 9000. | `number` | `8888` | no |
...
| <a name="input_metrics_port"></a> [metrics\_port](#input\_metrics\_port) | (Deprecated) Port which will respond with metrics on the sidecar.<br><br>This value is deprecated for sidecars v4.7.0 and above, being hardcoded to port 9000. | `number` | `9000` | no |
