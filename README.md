...
| <a name="input_custom_user_data"></a> [custom\_user\_data](#input\_custom\_user\_data) | Acillary consumer supplied user-data script. Appended to existing user-data sidecar bootstrapping scripts (Approx Input Size = 19KB) | `string` | n/a | no |
