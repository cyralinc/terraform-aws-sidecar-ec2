...
| <a name="input_secrets_kms_key_id"></a> [secrets\_kms\_key\_id](#input\_secrets\_kms\_key\_id) | ARN of the KMS key key used to encrypt secrets. If not set, secrets will use the default KMS key. | `string` | `""` | no |
