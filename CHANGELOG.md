...
Health checks and metrics were merged to a single monitoring port starting in sidecar `v4.7.0`. In this sense, the change required a major release for this module.
