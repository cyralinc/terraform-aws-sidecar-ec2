...
Health checks and metrics were merged in a single port for monitoring starting in sidecar `v4.7.0`. In this sense, the change required a major release for this module.
We used this major release to also clean up deprecated variables since the transition to control plane `v4`. The list of removed and added parameters is as follows:
...
* ENG-11417: Update template to use the new healthcheck endpoint and logic ([#60](https://github.com/cyralinc/terraform-cyral-sidecar-aws/pull/60))
* ENG-11888: Add external parameter to name cloudwatch log groups ([#65](https://github.com/cyralinc/terraform-cyral-sidecar-aws/pull/65))

### Backwards compatibility breaks:

* ENG-11847: Merge healthcheck and metrics inbound CIDR fields into a single monitoring inbound cidr ([#62](https://github.com/cyralinc/terraform-cyral-sidecar-aws/pull/62))
* Remove deprecated variables ([#63](https://github.com/cyralinc/terraform-cyral-sidecar-aws/pull/63))
